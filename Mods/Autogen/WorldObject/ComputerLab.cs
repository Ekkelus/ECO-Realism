namespace Eco.Mods.TechTree
{
    ...
    public partial class ComputerLabRecipe : Recipe
    {
        public ComputerLabRecipe()
        {
            ...
            SkillModifiedValue value = new SkillModifiedValue(260, ElectronicEngineeringSpeedSkill.MultiplicativeStrategy, typeof(ElectronicEngineeringSpeedSkill), "craft time");
