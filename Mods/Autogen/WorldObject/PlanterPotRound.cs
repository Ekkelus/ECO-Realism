namespace Eco.Mods.TechTree
{
    ...
    [RequireRoomVolume(4)]
    public partial class PlanterPotRoundObject : WorldObject
    {
    ...
    public partial class PlanterPotRoundRecipe : Recipe
    {
        public PlanterPotRoundRecipe()
        {
            ...
            SkillModifiedValue value = new SkillModifiedValue(5, StoneworkingSpeedSkill.MultiplicativeStrategy, typeof(StoneworkingSpeedSkill), "craft time");
