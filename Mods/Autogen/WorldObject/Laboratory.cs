namespace Eco.Mods.TechTree
{
    ...
    public partial class LaboratoryRecipe : Recipe
    {
        public LaboratoryRecipe()
        {
            ...
            SkillModifiedValue value = new SkillModifiedValue(120, IndustrialEngineeringSpeedSkill.MultiplicativeStrategy, typeof(IndustrialEngineeringSpeedSkill), "craft time");
