namespace Eco.Mods.TechTree
{
    ...
    [RequireRoomVolume(4)]                              
    public partial class PaddedChairObject : WorldObject
    {
    ...
    public partial class PaddedChairRecipe : Recipe
    {
        public PaddedChairRecipe()
        {
            ...
            SkillModifiedValue value = new SkillModifiedValue(5, ClothProductionSpeedSkill.MultiplicativeStrategy, typeof(ClothProductionSpeedSkill), "craft time");
