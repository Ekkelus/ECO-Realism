namespace Eco.Mods.TechTree
{
    ...
    public partial class StreetlampRecipe : Recipe
    {
        public StreetlampRecipe()
        {
            ...
            SkillModifiedValue value = new SkillModifiedValue(1, ElectronicEngineeringSpeedSkill.MultiplicativeStrategy, typeof(ElectronicEngineeringSpeedSkill), "craft time");
