namespace Eco.Mods.TechTree
{
    ...
    public partial class WashingMachineRecipe : Recipe
    {
        public WashingMachineRecipe()
        {
            ...
            SkillModifiedValue value = new SkillModifiedValue(10, IndustrialEngineeringSpeedSkill.MultiplicativeStrategy, typeof(IndustrialEngineeringSpeedSkill), "craft time");
