namespace Eco.Mods.Organisms
{
    ...
    public class Pineapple : PlantEntity
    {
        ...
        public class PineappleSpecies : PlantSpecies
        {
            public PineappleSpecies() : base()
            {
                ...
                this.SeedItemType = typeof(PineappleSeedItem);
                this.PostHarvestingGrowth = 0.5f;
                this.ScythingKills = true;
                this.PickableAtPercent = 0.8f;
                this.ResourceItemType = typeof(PineappleItem);
                this.ResourceRange = new Range(1f, 1f);
    ...
    [Serialized, MoveEfficiency(0.8f), Reapable]
